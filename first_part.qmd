...
=======
The meta-data for these databases is taken from the UN's Staistics Division website : we clicked on dowload the CSV version <https://unstats.un.org/unsd/methodology/m49/overview/>
>>>>>>> 38f33dd13916698499e47181f985ce1a6c8b71e2
...
The data is compiled by the **Inter-Parliamentary Union (IPU)** ([www.ipu.org](http://www.ipu.org)) based on information provided by National Parliaments. The data is compiled every year.
